...
def test_create_generated_text(client, auth_header, new_generated_text):
    ...
    with patch('app.resources.view.generate_openai_response', return_value="Generated response"):
...
def test_update_generated_text(client, auth_header, user_with_generated_text):
    with patch('app.resources.view.generate_openai_response', return_value="Generated response update"):
        user, generated_text = user_with_generated_text
...
"test access to resources not owned by user"
